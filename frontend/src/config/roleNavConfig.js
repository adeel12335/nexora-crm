export const roles = {
  admin: {
    ...
    nav: [
      ...
      { to: '/admin/data-center', label: 'Data Center', icon: 'i-building' },
  ...
  manager: {
    ...
    nav: [
      ...
      { to: '/manager/follow-ups', label: 'Follow-ups', icon: 'i-message' },
  ...
  agent: {
    ...
    nav: [
      ...
      { to: '/agent/follow-ups', label: 'Follow-ups', icon: 'i-message' },
