  ...
  return (
    <>
      <section className="stats-grid">
        <StatCard tone="orange" icon="i-message" label="To Reply" value={pending.length} delta="Clients awaiting a reply" />
      ...
      <section className="page-section">
        <div className="section-heading">
          <div>
            <h2>Follow-ups</h2>
            <p>Remind yourself which clients still need a reply — private to you</p>
          </div>
        </div>
