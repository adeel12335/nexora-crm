...
export default function KanbanColumn({ stage, cards, selectedId, draggingId, onSelect, onDragStart, onDragEnd, onDrop, onAddCard }) {
  const [dragOver, setDragOver] = useState(false);

  return (
    <section className={`kanban-column${dragOver ? ' drag-over' : ''}`} style={{ '--stage': stage.color }}>
